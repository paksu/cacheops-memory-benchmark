    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('some_msg7', models.CharField(max_length=1024, null=True, blank=True)),
                ('some_msg8', models.CharField(max_length=1024, null=True, blank=True)),
                ('barmodel', models.ForeignKey(related_name='testmodels', verbose_name=b'BarModel', to='anotherapp.BarModel')),
                ('barmodel2', models.ForeignKey(related_name='more_test_models', verbose_name=b'BarModel2', to='anotherapp.BarModel2', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='BigModel4',
            fields=[
                ...
                ('some_msg7', models.CharField(max_length=1024, null=True, blank=True)),
                ('some_msg8', models.CharField(max_length=1024, null=True, blank=True)),
                ('bazmodel', models.ForeignKey(related_name='testmodels', verbose_name=b'BazModel', to='anotherapp.BazModel')),
                ('bazmodel2', models.ForeignKey(related_name='more_test_models', verbose_name=b'BazModel2', to='anotherapp.BazModel2', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='FooModel',
        ...
        migrations.AddField(
            ...
            name='foomodel',
            field=models.ForeignKey(related_name='testmodels', verbose_name=b'FooModel', to='anotherapp.FooModel'),
        ),
        migrations.AddField(
            model_name='bigmodel2',
            name='foomodel2',
            field=models.ForeignKey(related_name='more_test_models', verbose_name=b'FooModel2', to='anotherapp.FooModel2', null=True),
        ),
        migrations.AddField(
            model_name='bigmodel',
            name='testmodel',
            field=models.ForeignKey(related_name='testmodels', verbose_name=b'TestModel', to='anotherapp.TestModel'),
        ),
        migrations.AddField(
            model_name='bigmodel',
            name='testmodel2',
            field=models.ForeignKey(related_name='more_test_models', verbose_name=b'TestModel2', to='anotherapp.TestModel2', null=True),
        ),
    ]
