    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('counter', models.IntegerField(default=0)),
                ('counter2', models.IntegerField(default=0)),
                ('question', models.ForeignKey(to='someapp2.SomeModel')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('counter', models.IntegerField(default=0)),
                ('counter2', models.IntegerField(default=0)),
                ('question', models.ForeignKey(to='someapp2.SomeModel2')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('counter', models.IntegerField(default=0)),
                ('counter2', models.IntegerField(default=0)),
                ('question', models.ForeignKey(to='someapp2.SomeModel3')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('counter', models.IntegerField(default=0)),
                ('counter2', models.IntegerField(default=0)),
                ('question', models.ForeignKey(to='someapp2.SomeModel4')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('counter', models.IntegerField(default=0)),
                ('counter2', models.IntegerField(default=0)),
                ('question', models.ForeignKey(to='someapp2.SomeModel5')),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name='question',
            field=models.ForeignKey(to='someapp2.SomeModel'),
        ),
        migrations.AddField(
